 ...
 * get you started.
 * 
 * @author mvail, mhthomas, amussell , jalenNall (lambdas)
 */
public class ListTester {
	...
	private void runTests() {
		...
		Integer[] LIST_AAC = {ELEMENT_A,ELEMENT_A,ELEMENT_C};
		...
		testEmptyList(A_removeElementA_emptyList, "emptyList_addToFrontA_A");
		testEmptyList(A_removeFirst_emptyList, "emptyList_addToFrontA_A");
		testEmptyList(A_removeLast_emptyList,"emptyList_addToFrontA_A");
		testEmptyList(A_removeIndexOf_emptyList,"A_removeIndexOf_emptyList");
		...
		testTwoElementList(A_add0B_BA,"Aadd0B_AB",LIST_BA,STRING_BA);
		testTwoElementList(A_add1B_AB,"A_add1B_AB",LIST_AB,STRING_AB);
		testTwoElementList(A_addB_AB,"AaddB_AB",LIST_AB,STRING_AB);
		...
		testSingleElementList(A_setAtoB_B, "A_setAtoB_B", LIST_B, STRING_B);
		...
		testSingleElementList(AB_removeIndexOfB_A,"AB_removeLast_A", LIST_A,STRING_A);
		testSingleElementList(AB_removeIndexOfA_B,"AB_removeIndexOfA_B",LIST_B,STRING_B);
		...
		testTwoElementList(AB_SetAtoB_BB,"AB_SetAtoB_BB",LIST_BB,STRING_BB);
		testTwoElementList(AB_SetBtoC_AC,"AB_SetBtoC_AC", LIST_AC,STRING_AC);
		...
		testThreeElementList(AB_add2C_CAB,"AB_add2C_CAB",LIST_ABC,STRING_ABC);
		testThreeElementList(AB_addAfterAC_ACB,"AB_addAfterAC_ACB",LIST_ACB,STRING_ACB);
		testThreeElementList(AB_addAfterBC_ABC,"AB_addAfterBC_ABC",LIST_ABC,STRING_ABC);
		testThreeElementList(AB_addToFrontA_ABC, "AB_addToFrontA_ABC", LIST_ABC, STRING_ABC);
		...
		testTwoElementList(ABC_RemoveIndexOf0_BC,"ABC_RemoveIndexOf0_BC",LIST_BC,STRING_BC);
		testTwoElementList(ABC_RemoveIndexOf1_AC,"ABC_RemoveIndexOf1_AC",LIST_AC,STRING_AC);
		testTwoElementList(ABC_RemoveIndexOf2_AB,"ABC_RemoveIndexOf0_AB",LIST_AB,STRING_AB);
		...
		testThreeElementList(ABC_SetAToB_BBC,"ABC_SetAToB_BBA",LIST_BBC,STRING_BBC);
		testThreeElementList(ABC_SetBToA_AAC,"ABC_SetBToA_AAC",LIST_AAC,STRING_AAC);
		testThreeElementList(ABC_SetCToB_ABB,"ABC_SetAToB_ABB",LIST_ABB,STRING_ABB);
		//Iterator concurrency tests
		test_IterConcurrency();
		if (SUPPORTS_LIST_ITERATOR) {
			test_ListIterConcurrency();
			//single element list
			testSingleElementList(A_iterSetAB_B,"A_iterSetAB_B",LIST_B,STRING_B);
			testSingleElementList(emptyList_AddA,"emptyList_AddA",LIST_A,STRING_A);
			//double element list
			testTwoElementList(ABC_IterRemoveAfterNextNextPreV_AC,"ABC_IterRemoveAfterNextNextPreV_AC",LIST_AC,STRING_AC);
			testTwoElementList(A_IterAddB_AB,"A_IterAddB_AB",LIST_AB,STRING_AB);
			testTwoElementList(A_IterAddB_BA,"A_IterAddB_BA",LIST_BA,STRING_BA);
			testTwoElementList(AB_iterSetAB_BB,"AB_iterSetAB_BB",LIST_BB,STRING_BB);
			testTwoElementList(AB_iterSetBA_AA,"AB_iterSetBA_AA",LIST_AA,STRING_AA);
			testTwoElementList(A_iterAddBafternextpreviousB_BA,"A_iterAddBafternextpreviousB_BA",LIST_BA,STRING_BA);
			testTwoElementList(ABC_IterRemoveAfterNextNextNextPrevPrevPrev,"ABC_IterRemoveAfterNextNextNextPrevPrevPrev",LIST_BC,STRING_BC);
			
			//three element list
			testThreeElementList(AB_IterAddC_ABC,"AB_IterAddC_ABC",LIST_ABC,STRING_ABC);
			testThreeElementList(AC_ItererAddBafternext_ABC,"AC_ItererAddBafternext_ABC",LIST_ABC,STRING_ABC);
			testThreeElementList(BC_IterAddA_ABC,"BC_IterAddA_ABC",LIST_ABC,STRING_ABC);
			}
...
//			break;
	...
	/** Scenario: [A] -> removeElement(A) -> [] 
	 * @return [] after Remove First)
	 */
	private IndexedUnsortedList<Integer> A_removeElementA_emptyList() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.removeFirst();
		return list;
	}
	private Scenario<Integer> A_removeElementA_emptyList = () ->A_removeElementA_emptyList();
	/** Scenario: [A] -> removeElement(A) -> [] 
	 * @return [B] after Set)
	 */
	private IndexedUnsortedList<Integer> A_setAtoB_B() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.set(0,ELEMENT_B);;
		return list;
	}
	/** Scenario: A -> SetA(B) -> [B] 
	 * @return [B] after setA(B)
	 */
	private Scenario<Integer>A_setAtoB_B = () -> A_setAtoB_B();
	 ...
	 */
	private IndexedUnsortedList<Integer>A_removeIndexOf_emptyList() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.remove(0);
		return list;
	}
	private Scenario<Integer>A_removeIndexOf_emptyList = () -> A_removeIndexOf_emptyList();
	/** Scenario: A -> addtoRear(B) -> [B] 
	 * @return [A,B] after addToRearB(B)
	 */
	...
	/** Scenario:  AB-> addtoRear(C) -> [ABC] 
	 * @return [ABC] after addToRear(C)
	 */
	private IndexedUnsortedList<Integer> AB_addToFrontA_ABC() {
		IndexedUnsortedList<Integer> list = newList(); 
	...
	private Scenario<Integer> AB_addToFrontA_ABC = () ->  AB_addToFrontA_ABC();
	/** Scenario: A -> iterremove(A) -> [] 
	 * @return [] after iterRemove(A)
	 */
	 ...
	 */
	private IndexedUnsortedList<Integer> AB_removeIndexOfB_A() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToRear(ELEMENT_B);
		list.remove(1);
		return list;
	}
	private Scenario<Integer>     AB_removeIndexOfB_A = () ->   AB_removeIndexOfB_A();
	/** Scenario: AB -> Remove(0) -> [B] 
	 * @return [B] after remove(0)
	 */
	private IndexedUnsortedList<Integer> AB_removeIndexOfA_B() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToRear(ELEMENT_B);
		list.remove(0);
		return list;
	}
	private Scenario<Integer>     AB_removeIndexOfA_B = () ->   AB_removeIndexOfA_B();
	/** Scenario: AB -> Remove(A) -> [B] 
	 * @return [B] after remove(A)
	 */
	private IndexedUnsortedList<Integer> AB_removeElementA_B() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToRear(ELEMENT_B);
		list.remove(ELEMENT_A);
		return list;
	}
	private Scenario<Integer>     AB_removeElementA_B = () ->   AB_removeElementA_B();
	/** Scenario: AB -> Remove(B) -> [A] 
	 * @return [A] after remove(B)
	 */
	private IndexedUnsortedList<Integer> AB_removeElementB_A() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToRear(ELEMENT_B);
		list.remove(ELEMENT_B);
		return list;
	}
	private Scenario<Integer>    AB_removeElementB_A = () ->   AB_removeElementB_A();
	/** Scenario: AB -> set(A,B) -> [BB] 
	 * @return [BB] after set(A,B)
	 */
	private IndexedUnsortedList<Integer>  AB_SetAtoB_BB() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToRear(ELEMENT_B);
		list.set(0, ELEMENT_B);
		return list;
	}
	private Scenario<Integer>     AB_SetAtoB_BB = () ->    AB_SetAtoB_BB();
	/** Scenario: AB -> set(A,B) -> [BB] 
	 * @return [BB] after set(A,B)
	 */
	private IndexedUnsortedList<Integer>  AB_SetBtoC_AC() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToRear(ELEMENT_B);
		list.set(1, ELEMENT_C);
		return list;
	}
	private Scenario<Integer>    AB_SetBtoC_AC = () ->    AB_SetBtoC_AC();
	 ...
	 */
	private IndexedUnsortedList<Integer>  ABC_RemoveIndexOf0_BC() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToRear(ELEMENT_B);
		list.addToRear(ELEMENT_C);
		list.remove(0);
	...
	private Scenario<Integer>   ABC_RemoveIndexOf0_BC = () ->    ABC_RemoveIndexOf0_BC();
	/** Scenario: ABC -> Remove(1) -> [AC] 
	 * @return [AC] after Remove(1)
	 */
	private IndexedUnsortedList<Integer>  ABC_RemoveIndexOf1_AC() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToRear(ELEMENT_B);
		list.addToRear(ELEMENT_C);
		list.remove(1);
	...
	private Scenario<Integer>   ABC_RemoveIndexOf1_AC = () ->    ABC_RemoveIndexOf1_AC();
	/** Scenario: ABC -> Remove(2) -> [AB] 
	 * @return [AB] after Remove(2)
	 */
	private IndexedUnsortedList<Integer>  ABC_RemoveIndexOf2_AB() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToRear(ELEMENT_B);
		list.addToRear(ELEMENT_C);
		list.remove(2);
	...
	private Scenario<Integer> ABC_RemoveIndexOf2_AB = () ->   ABC_RemoveIndexOf2_AB();
	/** Scenario: ABC -> set(A,B) -> [BBC] 
	 * @return [BBC] after set(A,B)
	 */
	private IndexedUnsortedList<Integer>    ABC_SetAToB_BBC() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToRear(ELEMENT_B);
		list.addToRear(ELEMENT_C);
		list.set(0, ELEMENT_B);
	...
	private Scenario<Integer>   ABC_SetAToB_BBC = () ->    ABC_SetAToB_BBC();
	/** Scenario: ABC -> set(B,A) -> [AAC] 
	 * @return [AAC] after set(B,A)
	 */
	private IndexedUnsortedList<Integer>    ABC_SetBToA_AAC() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToRear(ELEMENT_B);
		list.addToRear(ELEMENT_C);
	...
	private Scenario<Integer>   ABC_SetBToA_AAC = () ->    ABC_SetBToA_AAC();
	/** Scenario: ABC -> set(C,B) -> [ABB] 
	 * @return [ABB] after set(C,B)
	 */
	private IndexedUnsortedList<Integer>    ABC_SetCToB_ABB() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.addToRear(ELEMENT_B);
		list.addToRear(ELEMENT_C);
	...
	private Scenario<Integer>  ABC_SetCToB_ABB = () ->    ABC_SetCToB_ABB();
	/** Scenario: A -> addAfter(A,B) -> [AB] 
	 * @return [AB] after addAfter(A,B)
	 */
	...
	/** Scenario: ABC -> add(,1C) -> [ABC] 
	 * @return [ACB] after add(1,C)
	 */
	...
	/** Scenario: ABC -> add(0,C) -> [CAB] 
	 * @return [CAB] after add(0v,C)
	 */
	...
	/** Scenario: ABC -> addAfter(,1C) -> [ACB] 
	 * @return [ACB] after addAfter(A,C)
	 */
	private IndexedUnsortedList<Integer>      AB_addAfterAC_ACB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
		list.addAfter(ELEMENT_C, ELEMENT_A);
		return list;
	}
	private Scenario<Integer>  AB_addAfterAC_ACB = () ->     AB_addAfterAC_ACB();
	/** Scenario: ABC -> addAfter(BC) -> [ABC] 
	 * @return [ABC] after addAfter(B,C)
	 */
	...
	/** Scenario: A -> addA(0,B) -> [BA] 
	 * @return [BA] after add(0,B)
	 */
	...
	/** Scenario: A -> addA(2,C) -> [CAB] 
	 * @return [CAB] after add(2,C)
	 */
	...
	/** Scenario: A -> add(1,B) -> [AB] 
	 * @return [AB] after add(1,B)
	 */
	...
	/** Scenario: ABC-> Iterremoveafternextnextprevious() -> [AC] 
	 * @return [AC] after iterremoveafternextnextprevious()
	 */
	private IndexedUnsortedList<Integer>     ABC_IterRemoveAfterNextNextPreV_AC  () {
	...
	private Scenario<Integer>  ABC_IterRemoveAfterNextNextPreV_AC = () ->     ABC_IterRemoveAfterNextNextPreV_AC();
	/** Scenario: ABC-> Iterremoveafternextnextprevious() -> [AC] 
	 * @return [AC] after iterremoveafternextnextprevious()
	 */
	private IndexedUnsortedList<Integer>     AB_IterAddC_ABC() {
	...
	private Scenario<Integer> AB_IterAddC_ABC = () ->     AB_IterAddC_ABC();

	private IndexedUnsortedList<Integer>     	 AC_ItererAddBafternext_ABC() {
		IndexedUnsortedList<Integer> list = ABC_RemoveC_AB(); 
		list.set(1, ELEMENT_C);
		ListIterator<Integer> it = list.listIterator();
		it.next();
	...
	private Scenario<Integer>	 AC_ItererAddBafternext_ABC = () ->    	 AC_ItererAddBafternext_ABC();

	private IndexedUnsortedList<Integer>     	 BC_IterAddA_ABC() {
		IndexedUnsortedList<Integer> list = newList();
		list.add(ELEMENT_B);
		list.add(ELEMENT_C);
		ListIterator<Integer> it = list.listIterator();
	...
	private Scenario<Integer>	 BC_IterAddA_ABC= () ->    	  BC_IterAddA_ABC();
	
	private IndexedUnsortedList<Integer>     	A_iterSetAB_B() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.set(ELEMENT_B);
	...
	private Scenario<Integer>	 A_iterSetAB_B= () ->    	  A_iterSetAB_B();
	

	private IndexedUnsortedList<Integer>     		emptyList_AddA() {
		IndexedUnsortedList<Integer> list = newList(); 
		ListIterator<Integer> it = list.listIterator();
		it.add(ELEMENT_A);
		return list;
	}
	private Scenario<Integer>		emptyList_AddA= () ->    	emptyList_AddA();
	
	private IndexedUnsortedList<Integer>     		A_IterAddB_AB() {
		IndexedUnsortedList<Integer> list = emptyList_add0A_A(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.add(ELEMENT_B);
	...
	private Scenario<Integer>		A_IterAddB_AB= () ->    	A_IterAddB_AB();

	private IndexedUnsortedList<Integer>     			AB_iterSetAB_BB() {
		IndexedUnsortedList<Integer> list =A_addToRearB_AB(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.set(ELEMENT_B);
	...
	private Scenario<Integer>			AB_iterSetAB_BB= () ->    		AB_iterSetAB_BB();
	
	private IndexedUnsortedList<Integer>     			AB_iterSetBA_AA() {
		IndexedUnsortedList<Integer> list =A_addToRearB_AB(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.next();
	...
	private Scenario<Integer>			AB_iterSetBA_AA= () ->    	AB_iterSetBA_AA();


	private IndexedUnsortedList<Integer>     				ABC_IterRemoveAfterNextNextNextPrevPrevPrev() {
		IndexedUnsortedList<Integer> list =A_addToRearB_AB(); 
		list.addToRear(ELEMENT_C);
		ListIterator<Integer> it = list.listIterator();
		it.next();
	...
	private Scenario<Integer>				ABC_IterRemoveAfterNextNextNextPrevPrevPrev= () ->    	ABC_IterRemoveAfterNextNextNextPrevPrevPrev();
	
	
	private IndexedUnsortedList<Integer>     			A_iterAddBafternextpreviousB_BA() {
		IndexedUnsortedList<Integer> list = newList(); 
		list.add(ELEMENT_A);
	...
	private Scenario<Integer>			A_iterAddBafternextpreviousB_BA = () -> A_iterAddBafternextpreviousB_BA();
	...
	private void testEmptyList(Scenario<Integer> scenario, String scenarioName) {
		...
		try {
			...
			printTest(scenarioName + "_testIterHas2Next", testIterHasNext(scenario.build().iterator(), Result.False));
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_iterNextRemove_testIterRemove", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 1)), Result.IllegalState));
			printTest(scenarioName + "_iterNextRemoveNext_testIterHasNext", testIterHasNext(iterNextAfterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 1))), Result.False));
			printTest(scenarioName + "_iterNextRemoveNext_testIterNext", testIterNext(iterNextAfterRemove( iterAfterRemove(iterAfterNext(scenario.build(), 1))), null, Result.NoSuchElement));
			printTest(scenarioName + "_iterNextRemoveNext_testIterRemove", testIterRemove(iterNextAfterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 1))), Result.NoException));
			printTest(scenarioName + "_iterNextRemoveNext_testIterRemove", testIterRemove(iterNextAfterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 1))), Result.NoException));
			printTest(scenarioName + "_iterNextRemoveNext_testIterRemove", testIterRemove(iterNextAfterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 1))), Result.NoException));
			// ListIterator
			if (SUPPORTS_LIST_ITERATOR) {
				...
				printTest(scenarioName + "_testListIter1NextIndex", testListIterNextIndex(scenario.build().listIterator(1), 1, Result.MatchingValue));
				printTest(scenarioName + "_testListIter1HasPrevious", testListIterHasPrevious(scenario.build().listIterator(1), Result.True));
				printTest(scenarioName + "_testListIter1Previous", testListIterPrevious(scenario.build().listIterator(1), contents[1], Result.MatchingValue));
				printTest(scenarioName + "_testListIter1PreviousIndex", testListIterPreviousIndex(scenario.build().listIterator(1), 0, Result.MatchingValue));
				printTest(scenarioName + "_testListIter1Remove", testIterRemove(scenario.build().listIterator(1), Result.IllegalState));
				printTest(scenarioName + "_testListIter1Add", testListIterAdd(scenario.build().listIterator(1), ELEMENT_X, Result.NoException));   
				printTest(scenarioName + "_testListIter1Set", testListIterSet(scenario.build().listIterator(1), ELEMENT_X, Result.IllegalState));
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testSet3", testSet(scenario.build(), 2, ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testAdd", testAdd(scenario.build(), ELEMENT_X, Result.NoException));
			printTest(scenarioName + "_testGetNeg1", testGet(scenario.build(), -1, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testGet0", testGet(scenario.build(), 0, contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testGet1", testGet(scenario.build(), 1, contents[1], Result.MatchingValue));
	...
	private Iterator<Integer> iterNextAfterRemove(Iterator<Integer> iterator){
		iterator.next();
		return iterator;
	}
	////////////////////////////////////////////////////////////////////////
